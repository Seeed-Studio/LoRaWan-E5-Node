...
#define __STM32WLXX_LoRa_E5_mini_BSP_VERSION        ((__STM32WLXX_LoRa_E5_mini_BSP_VERSION_MAIN << 24)\
...
#define BUTTONx_GPIO_CLK_ENABLE(__INDEX__)     do { BUTTON_SW1_GPIO_CLK_ENABLE(); } while(0)

#define BUTTONx_GPIO_CLK_DISABLE(__INDEX__)    do { BUTTON_SW1_GPIO_CLK_DISABLE();} while(0)
